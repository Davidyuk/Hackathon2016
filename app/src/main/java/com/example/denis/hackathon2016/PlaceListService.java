...
class PlaceListService implements LocationListener {
    ...
    private String apiUrlTemplate = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=%.5f,%.5f&radius=500&key=AIzaSyDdoJgqAEG8phS2DH-97N4YnyxehqjSwKE";
